...
> ✨ This project marks my **first hands-on experience with APIs**, bringing real-world weather data into a user-friendly web interface!
...
- 🌦️ Dynamic weather icons using WeatherAPI
...
Replace `YOUR_API_KEY` with your personal key from [weatherapi.com](https://www.weatherapi.com/).
...
- Basic API integration in frontend apps
- Styling UI with responsive design principles
...
- Add loading animation and error badges
- Geo-location based auto-weather fetch
